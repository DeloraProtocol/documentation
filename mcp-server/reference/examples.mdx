...
These examples show how to use the Delora MCP tools: typical prompts, tool arguments, and response structures. They are based on the [Delora API](https://api.delora.build) and the MCP server implementation.
...
### TypeScript (MCP SDK, streamable HTTP)
...
<CardGroup cols={2}>
  <Card title="Available Tools" icon="wrench" href="/mcp-server/reference/available-tools">
    Full list of MCP tools and parameters.
  </Card>
  <Card title="API Reference" icon="book" href="/api-reference/alyra-api-v1">
