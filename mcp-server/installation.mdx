---
title: "Install the Delora MCP Server"
description: "Connect to the hosted Delora MCP endpoint or install the npm package locally in Claude Desktop, Cursor, VS Code, Codex, or another MCP client."
