---
title: "Delora MCP Server for Cross-Chain Swaps"
description: "Connect AI agents and developer tools to Delora cross-chain swap quotes, token metadata, and routing through the Model Context Protocol."
