---
title: "Delora Cross-Chain Swap Widget"
description: "Embed same-chain and cross-chain swaps in a React application with the Delora widget, built-in wallet flows, configurable tokens, and event hooks."
