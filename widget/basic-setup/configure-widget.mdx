...
| --- | --- | --- |
| `apiUrl` | `string` | Delora API base used for `/v1/chains`, `/v1/tokens`, `/v1/tools`, and `/v1/quotes` |
...
For browser-based widget integrations, do not pass `apiKey` directly from the client. Instead:
