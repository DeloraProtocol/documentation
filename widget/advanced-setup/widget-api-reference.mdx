...
description: "Reference the components, configuration props, hooks, event payloads, wallet providers, and TypeScript types exported by Delora widget packages."
