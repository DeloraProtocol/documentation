---
title: "Delora Cross-Chain Swap Infrastructure"
description: "Explore Delora's API infrastructure for embedding same-chain and cross-chain swaps, routing, execution, monetization, and analytics in wallets and dApps."
"og:image": "https://docs.delora.build/images/docs-og.png"
---

Delora is building infrastructure that enables developers to embed cross-chain swaps directly into their applications.
...
- **Security-first** \
  Every transaction runs through transparent contracts with encoded execution constraints. If those constraints are not met, execution is designed to fail instead of proceeding with an unsupported route.
- **Modularity** \
