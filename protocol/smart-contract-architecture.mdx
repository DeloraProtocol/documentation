---
title: "Delora Smart Contract Architecture"
description: "Explore Delora's modular EIP-2535 Diamond architecture, facet contracts, execution flow, access controls, and upgrade model."
